           ...
           (;; (agenda ""
            ...
            (todo "NEXT"
                  ((org-agenda-overriding-header "In Progress")
                   (org-agenda-files `(,(concat tk/org-directory "someday.org")
                                       ,(concat tk/org-directory "next.org")
                                       ,(concat tk/org-directory "cw.org")
                                       ,(concat tk/org-directory "projects.org")))))
            ;; One offs (next.org)
            (todo "TODO"
            ...
            (todo "TODO"
                       ((org-agenda-overriding-header "Read/Watch/Listen")
                        (org-agenda-files `(,(concat tk/org-directory "media.org")))))
            ;; Personal Stuff
