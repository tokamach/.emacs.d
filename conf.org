...
#+BEGIN_SRC emacs-lisp
  (use-package org-static-blog
    ...
    (setq org-static-blog-publish-directory "~/doc/org/journal/publish/")
    (setq org-static-blog-posts-directory "~/doc/org/journal/publish/posts/")
    (setq org-static-blog-drafts-directory "~/doc/org/journal/publish/drafts/"))
#+END_SRC

We'll have to set a long and annoying preamble:
