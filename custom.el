...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/doc/org/cars.org" "~/doc/org/clocktables.org" "~/doc/org/coffee.org" "~/doc/org/cw.org" "~/doc/org/inbox.org" "~/doc/org/jobs.org" "~/doc/org/media.org" "~/doc/org/next.org" "~/doc/org/personal.org" "~/doc/org/projects.org" "~/doc/org/shopping-list.org" "~/doc/org/someday.org"))
 ...
 '(tao-theme-sepia-saturation 1.13)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 ;; '(fixed-pitch ((t (:family "" :slant normal :weight normal :height 1.0 :width normal))))
 '(variable-pitch ((t (:family "ET Book" :height 140 :weight light)))))
